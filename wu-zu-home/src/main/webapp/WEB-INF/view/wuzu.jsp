...
<article>
  <h1>WUZU</h1>
  <p>우주는 Hello, world!의 오마주인 Change, world!라는, 세상을 바꾸자는 큰 목표를 가지고 작은 것부터 실천 중인 네명의 개발자 모임입니다. 계속...</p>
...
<aside>
  ...
  <ul>
    ...
    <li>Communication : <a href="https://wuzu.slack.com" target="_blank">Slack</a></li>
    <li>계속...</li>
  </ul>
</aside>
